...
namespace AC
{
	...
	public class Menu : ScriptableObject
	{
		...
		public void ShowGUI ()
		{
			...
			actionListOnTurnOn = ActionListAssetMenu.AssetGUI ("ActionList when turn on:", actionListOnTurnOn, apiPrefix + ".actionListOnTurnOn");
			actionListOnTurnOff = ActionListAssetMenu.AssetGUI ("ActionList when turn off:", actionListOnTurnOff, apiPrefix + ".actionListOnTurnOff");
