		...
		public virtual void ShowGUI (Menu menu)
		{
			...
			if (menu.menuSource != MenuSource.AdventureCreator)
			{
				if (isClickable)
				{
					...
					hoverSound = (AudioClip) CustomGUILayout.ObjectField <AudioSource> ("Hover sound:", hoverSound, false, apiPrefix + ".hoverSound");
					clickSound = (AudioClip) CustomGUILayout.ObjectField <AudioSource> ("Click sound:", clickSound, false, apiPrefix + ".clickSound");
					EditorGUILayout.EndVertical ();
				}
				return;
			}
