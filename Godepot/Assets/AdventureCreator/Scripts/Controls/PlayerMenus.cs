...
namespace AC
{
	...
	public class PlayerMenus : MonoBehaviour
	{
		...
		public bool SlotIsInteractive (AC.Menu menu, int elementIndex, int i)
		{
			...
			/*if (menu.IsVisible () && menu.elements[elementIndex].isClickable && 
			  ((KickStarter.settingsManager.inputMethod == InputMethod.MouseAndKeyboard && menu.IsPointerOverSlot (menu.elements[elementIndex], i, KickStarter.playerInput.GetInvertedMouse ())) ||
			  (KickStarter.settingsManager.inputMethod == InputMethod.TouchScreen && menu.IsPointerOverSlot (menu.elements[elementIndex], i, KickStarter.playerInput.GetInvertedMouse ())) ||
			  (KickStarter.settingsManager.inputMethod == InputMethod.KeyboardOrController && KickStarter.stateHandler.gameState == GameState.Normal && menu.IsPointerOverSlot (menu.elements[elementIndex], i, KickStarter.playerInput.GetInvertedMouse ())) ||
			  ((KickStarter.settingsManager.inputMethod == InputMethod.KeyboardOrController && KickStarter.stateHandler.gameState == GameState.Paused && menu.selected_element == menu.elements[elementIndex] && menu.selected_slot == i))) ||
				((KickStarter.settingsManager.inputMethod == InputMethod.KeyboardOrController && KickStarter.stateHandler.gameState == GameState.Cutscene && menu.CanClickInCutscenes () && menu.selected_element == menu.elements[elementIndex] && menu.selected_slot == i))) ||
				((KickStarter.settingsManager.inputMethod == InputMethod.KeyboardOrController && KickStarter.stateHandler.gameState == GameState.DialogOptions && menu.selected_element == menu.elements[elementIndex] && menu.selected_slot == i))) ||
			  ((KickStarter.settingsManager.inputMethod == InputMethod.KeyboardOrController && KickStarter.stateHandler.gameState == GameState.Normal && menu.CanControlDuringGameplay () && menu.selected_element == menu.elements[elementIndex] && menu.selected_slot == i))))
			{
				return true;
			}
			return false;*/
